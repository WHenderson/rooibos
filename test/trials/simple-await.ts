...
describe('root/describeA', async () => {
    ...
    await describe('root/describeA/describeY', async () => {
        console.log('20');
    ...
    describe('root/describeA/describeZ', async () => {
        ...
        await test('root/describeA/describeZ/testB', async () => {
            console.log('40');
        });
...
describe('root/describeB', async () => {
    ...
    describe('root/describeB/describeX', async () => {
        ...
        test('root/describeB/describeX/testA', async () => {
            console.log('56');
        });

        test('root/describeB/describeX/testB', async () => {
            console.log('59');
        });

        test('root/describeB/describeX/testC', async () => {
            console.log('62');
        });
    });
